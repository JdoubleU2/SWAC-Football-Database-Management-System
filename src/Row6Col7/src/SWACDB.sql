...
INSERT INTO Player (PlayerID, Name, TeamID, Position, JerseyNumber, Year, Height, Weight, Birthdate, Hometown, HighSchool)
VALUES
(1, 'Ja\'koby Banks', 10, 'WR', 1, 'Jr.', 5.09, 178, NULL, 'Missouri City, Texas', 'Fort Bend HS'),
(2, 'Cameron Franklin', 10, 'S', 2, 'Sr.', 6.02, 200, NULL, 'Sweeny, Texas', 'Van Vleck HS'),
(3, 'Sterling Roberts', 10, 'LB', 3, 'R-Sr.', 6.01, 200, NULL, 'Starke, Florida', 'Bradford HS')
(4, 'Cameron Peters', 10, 'QB', 4, 'Sr.', 6.04, 207, NULL, 'Missouri City, Texas', 'Stafford HS'),
(5, 'Travor Randle', 10, 'S', 4, 'Gr.', 5.10, 205, NULL, 'Greenwood, Mississippi', 'Greenwood HS'),
(6, 'Ethan John', 10, 'TE', 5, 'Jr.', 6.03, 230, NULL, 'Milwaukee, Wisconsin', 'Oak Creek HS'),
(7, 'Malik Gucake', 10, 'DL', 6, 'Sr.', 6.03, 250, NULL, 'Sacramento, California', 'Sheldon HS'),
(8, 'Kennedy Parker', 10, 'LB', 7, 'Gr.', 6.01, 210, NULL, 'Macon, Georgia', 'Westside HS'),
(9, 'Travon Jones', 10, 'TE', 8, 'Gr.', 6.07, 230, NULL, 'Miami, Florida', 'Dutchtown HS'),
(10, 'Rodny Ojo', 10, 'WR', 9, 'So.', 6.02, 175, NULL, 'Houston, Texas', 'Klein Collins HS');
